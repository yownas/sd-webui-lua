...
def lua_reset():
    ...
    G.sd = {}
    G.sd["console"] = sd_lua_console
    G.sd["clear"] = sd_lua_output_clear
    G.sd["process"] = sd_lua_process
    G.sd["pipeline"] = sd_lua_pipeline
    G.sd["gallery_add"] = sd_lua_gallery_add
    G.sd["gallery_clear"] = sd_lua_gallery_clear

    G.sd["clip"] = sd_lua_clip
    G.sd["empty_latent"] = sd_lua_empty_latent
    G.sd["ksampler"] = sd_lua_ksampler
